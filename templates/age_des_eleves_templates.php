                    ...
                    <?php endif; ?>
                      <li class="active sub-menu">
                        ...
                        <ul>
                            ...
                            <li><a class="active" href="age_des_eleves.php">Age des élèves</a></li>
...
"></i>Affichage des résultats</a>
                        ...
                        <div id="todo1" class="card">
                            <div class="card-header bgm-bluegray1 ch-alt m-b-20">
                               ...
                               <?php if(isset($_SESSION['paroisse'])):
                                    ...
                                    echo "ENREGISTREMENT AGE DES ELEVES DANS LA PAROISSE ".$np[0]["nom_paroisse"];
                                ?>
                                <?php else: 
                                    echo "ENREGISTREMENT AGE DES ELEVES DANS TOUTES LES PAROISSES";
        ...
        foreach ($table_option1 as $option1) {
           ...
           $class_str_org = query("SELECT COUNT(DISTINCT belongs_to) as nbr FROM age_eleves WHERE belongs_to = ?",$id_e);
            ...
            if ($class_str_org[0]["nbr"] == 0) {
                echo("<option  value='$nom_ecole**$niveau**$nom_p**$nom_sous_d'>" .$nom_ecole ."</option>");
                                    ...
                                    <div class="col-sm-2">
                                        <button id="select_age_ecole_btn" class="btn btn-primary">Confirmer</button>
                                    </div>
        ...
        echo '
                                ...
                                <div class="modal-header1 ">
                                            <h4 class="modal-title p-l-20">Modifier age des élèves</h4>
                                        </div>
...
<select id="select_ecole_mod" data-live-search="true" class="selectpicker"  title="Selectionner une école" data-selected-text-format="count" tabindex="-98"  >';
                                    ...
                                    {  
                                        ...
                                        if (count($coord) >= 1) {
                                            foreach ($coord as $res ) {
                                               $id = $res["id"];
                                                $class_str_org = query("SELECT COUNT(DISTINCT belongs_to) as nbr FROM age_eleves WHERE belongs_to = ?",$id);
            ...
            if ($class_str_org[0]["nbr"] == 0) {
                                     ...
                                     echo '</select></div>
                                     <div class="col-sm-2">
                                     <button id="button_age_elev_mod" class="btn btn-primary ">Confirmer</button>
                                     </div>
                                     <div class="row">
    ...
    ?>
                ...
                <form id="ages_eleves_mat_form"  class="row" style="display: none;">
...
echo "<tr id='tabageeleve$i'>";
    ...
    if ( $j==0 || $j==1 || $j==2  ) {
     echo "<td><input autocomplete='false' id='tabageeleve$i$j' type='text' class='form-control tabageeleve tabageeleve$i$j' name='tabageeleve$i$j'></td>";
    }
...
echo "</tr>"; 
    ...
    <button id="structuremat_form_button" class="btn btn-info col-sm-12 waves-effect btn-lg" type="submit"  >ENREGISTRER</button>
                            <span class="affreslt_ecole"></span>
                              <input type="hidden" name="current_ecole_structure2" id="current_ecole_structure">
                   </form>



            <form id="ages_eleves_pri_form"  class="row" style="display: none;">
...
echo "<tr id='tabageelevepri$i'>";
    ...
    if ( $j==0 || $j==1 || $j==2 || $j==3 || $j==4 ||$j==5 ||$j==6 ||$j==7 ||$j==8 ||$j==9 ||$j==10 ||$j==11 ||$j==12 ||$j==13 ) {
     echo "<td><input autocomplete='false' id='tabageelevepri$i$j' type='text' class='form-control tabageelevepri tabageelevepri$i$j' name='tabageelevepri$i$j'></td>";
    }
...
echo "</tr>"; 
    ...
    <button id="stucturepri_form_button" class="btn btn-info col-sm-12 waves-effect btn-lg" type="submit">ENREGISTRER</button>
                    ...
                    <form id="ages_eleves_sec_form"  class="row" style="display: none;">
...
echo "<tr id='tabageelevesec$i'>";
    ...
    if ( $j==0 || $j==1 || $j==2 || $j==3 || $j==4 ||$j==5 ||$j==6 ||$j==7 ||$j==8 ||$j==9 ||$j==10||$j==11 ) {
     echo "<td><input autocomplete='false' id='tabageelevesec$i$j' type='text' class='form-control tabageelevesec tabageelevesec$i$j' name='tabageelevesec$i$j'></td>";
    }
...
echo "</tr>"; 
    ...
    <button id="stucturesec_form_button" class="btn btn-info col-sm-12 waves-effect btn-lg" type="submit">ENREGISTRER</button>
                            <span class="affreslt_ecole"></span>
                            <input type="hidden" name="current_ecole_structure2" id="current_ecole_structure3">
                   </form>
