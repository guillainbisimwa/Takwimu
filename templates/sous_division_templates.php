                ...
                <ul class="main-menu">
                    ...
                    <li class="sub-menu active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="sous_division.php">Paroisse</a></li>
...
"></i>Affichage des résultats</a>
        ...
        echo '
                                ...
                                <div class="modal-header1 ">
                                            <h4 class="modal-title p-l-20">Modifier une paroisse</h4>
                                        </div>
                                    <div class="modal-content1 p-20">
                                    

                                       <div class="col-sm-10">
<select id="select_ecole" data-live-search="true" class="selectpicker"  title="Selectionner une paroisse" data-selected-text-format="count" tabindex="-98"  >';
                                         
                                       /*for ($i=0; $i <4 ; $i++) { 
                                           echo("<option value='**op1'>" ."btrr" . "</option>");
                                       }*/
                                    $diocese = query("SELECT * FROM paroisse2 ");
                                   foreach ($diocese as $sec)  
                                    {  
                                        ...
                                        $coord = query("SELECT * FROM sous_div WHERE belongs_to = ?  ",$id_d);
                                        if (count($coord) >= 1) {
                                            foreach ($coord as $res ) {
                                               $id = $res["id"];
                                               $nom_sous_div = $res["nom_sous_div"];
                                             echo("<option value='$id**$nom_d**$nom_sous_div**$id_d'>" .$res["nom_sous_div"]. "</option>");
                                     ...
                                     echo '</select></div>
                                     <div class="col-sm-2">
                                     <button id="btn_select_sous_div" class="btn btn-primary ">Confirmer</button>
                                     </div>
                                     <div class="row">
                            ...
                            <div class="input-group fg-float  left">
                                <span class="input-group-addon"><i class="zmdi zmdi-balance"></i></span>
                                    <div class="fg-line ">
                                    <input id="id_sous_div" type="hidden" class="form-control" />
                                    <input id="id_paroisse" type="hidden" class="form-control" />
                                        <input value=" " autocomplete="off" id="nom_sous_div_mod"  type="text" class="form-control">
                            ...
                            <div class="input-group fg-float  left">
                                <span class="input-group-addon"><i class="zmdi zmdi_naledi zmdi-balance"></i></span>
                                    <div class="fg-line">
                                       <select  id="nom_paroisse_sd_mod" data-live-search="true" class="selectpicker" title="Sous division" >
                                        ';
                                    ...
                                    echo '
                                        ...
                                        <div class="tab-actions p-20">
                                            <button id="mod_sous_div" class="btn btn-danger btn-icon-text waves-effect">
    ...
    ?>
                        ...
                        <div class="modal fade in" id="modalAjouterParoiss" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div id="my_form_diocz" class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Ajouter une paroisse</h4>
                                        </div>
                            ...
                            <div class="input-group fg-float  left">
                                <span class="input-group-addon"><i class="zmdi zmdi_naledi zmdi-balance"></i></span>
                                    <div class="fg-line">
                                       <select  id="nom_paroisse_sd" data-live-search="true" class="selectpicker" title="Sous division" >
                                        <?php  
                                    ...
                                    ?>
                                        ...
                                        <div class=" modal-footer ">
                                            <button id="Enregistrer_sous_div" type="submit" class="btn waves-effect btn-primary">Enregistrer</button>
