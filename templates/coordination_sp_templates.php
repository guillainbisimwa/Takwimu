                ...
                <ul class="main-menu">
                    ...
                    <li class="sub-menu active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="coordination_sp.php">Coordination sous provinciale</a></li>
...
"></i>Affichage des résultats</a>
                    ...
                    <?php if(isset($_SESSION['current_session'])): ?>
                        <div id="todo1" class="card">
                            <div class="card-header bgm-bluegray ch-alt m-b-20">
                                <h2>COORDINATION SOUS PROVINCIALE </h2>
                                <ul class="actions">
                                        <li>
                                            <a href="#">
                            ...
                            <div class="card-body ">
                                <div class="t-add">
                                    ...
                                    <!-- <div class="ta-block p-20">
                                        Modification coordination sous provincile
        ...
        echo '
                                ...
                                <div class="modal-header1 ">
                                            <h4 class="modal-title p-l-20">Modifier une coordination sous pronvinciale</h4>
                                        </div>
                                    <div class="modal-content1 p-20">
                                    

                                       <div class="col-sm-10">
<select id="select_ecole_mod" data-live-search="true" class="selectpicker"  title="Selectionner une coordination sous pronvinciale" data-selected-text-format="count" tabindex="-98"  >';
                                   ...
                                   foreach ($diocese as $sec)  
                                    {  
                                        $nom_d = $sec["nom_diocese"];
                                        $id_d = $sec["id"];

                                        echo("<optgroup label='Diocese de $nom_d'>");
                                        $coord = query("SELECT * FROM coordination_sp WHERE belongs_to = ?",$id_d);
                                        if (count($coord)>=1) {
                                            foreach ($coord as $res) {
                                                $id = $res["id"];
                                                $nom_coord_sp = $res["nom_coord_sp"];
                                                $id = $res["id"];
                                             echo("<option value='$id**$nom_d**$nom_coord_sp**$id_d'>" .$res["nom_coord_sp"]. "</option>");
                                            }
                                        }
                                     ...
                                     echo '</select></div>
                                     <div class="col-sm-2">
                                     <button id="btn_select_coord_mod" class="btn btn-primary ">Confirmer</button>
                                     </div>
                                     <div class="row">
                            ...
                            <div class="input-group fg-float  left">
                                <span class="input-group-addon"><i class="zmdi zmdi-balance"></i></span>
                                    ...
                                    <input id="id_diocese" type="hidden" class="form-control" />

                                        <input value=" " autocomplete="off" id="nom_coord_sp_mod"  type="text" class="form-control">
                                        <label class="fg-label">Nom de la coordination sous provincile</label>
                                    </div>
                            </div>
                            ...
                            <div class="input-group fg-float  left">
                                <span class="input-group-addon"><i class="zmdi zmdi_naledi zmdi-balance"></i></span>
                                    <div class="fg-line">
                                       <select  id="select_dio_mod" data-live-search="true" class="selectpicker" title="Diocese" >';
                                    ...
                                    { 
                                        ...
                                        $id_d = $diocese["id"];
                                        $diocese_d = $diocese["nom_diocese"];
                                       
                                        echo("<option value='$id_d'>" .$diocese_d . "</option>"); 
                                    ...
                                    echo '</select>
                                        ...
                                        <div class="tab-actions p-20">
                                          <button id="mod_coord_sp" class="btn btn-danger btn-icon-text waves-effect">
    ...
    ?>
                        ...
                        <div class="modal fade in" id="modalAjouterParoiss" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div id="my_form_diocz" class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Ajouter une coordination sous provincile</h4>
                                        </div>
                            ...
                            <div class="input-group fg-float  left">
                                <span class="input-group-addon"><i class="zmdi zmdi-balance"></i></span>
                                    <div class="fg-line ">
                                        <input autocomplete="off" id="nom_coord_sp"  type="text" class="form-control">
                                        <label class="fg-label">Nom de la coordination sous provincile</label>
                                    </div>
                            </div>
                            ...
                            <div class="input-group fg-float  left">
                                <span class="input-group-addon"><i class="zmdi zmdi_naledi zmdi-balance"></i></span>
                                    <div class="fg-line">
                                       <select  id="nom_diocese" data-live-search="true" class="selectpicker" title="Diocese" >
                                    ...
                                    ?>
                                        ...
                                        <div class=" modal-footer ">
                                            <button id="Enregistrer_c_sp" type="submit" class="btn waves-effect btn-primary">Enregistrer</button>
