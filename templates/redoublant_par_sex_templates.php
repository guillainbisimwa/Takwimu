                    ...
                    <?php endif; ?>
                      <li class="active sub-menu">
                        ...
                        <ul>
                            ...
                            <li><a class="active" href="redoublant_par_sex.php">Redoublants par sexe</a></li>
...
"></i>Affichage des résultats</a>
                        ...
                        <div id="todo1" class="card">
                            <div class="card-header bgm-bluegray1 ch-alt m-b-20">
                               ...
                               <?php if(isset($_SESSION['paroisse'])):
                                    ...
                                    echo "ENREGISTREMENT D'EFFECTIFS DES REDOUBLANTS DANS LA PAROISSE ".$np[0]["nom_paroisse"];
                                ?>
                                <?php else: 
                                    echo "ENREGISTREMENT D'EFFECTIFS DES REDOUBLANTS DANS TOUTES LES PAROISSES";
        ...
        foreach ($table_option1 as $option1) {
            ...
            $class_sec_co = query("SELECT COUNT(DISTINCT belongs_to) as nbr FROM redoublants WHERE belongs_to = ?",$id_e);
           
            if ($class_sec_co[0]["nbr"] == 0) {
                echo("<option  value='$nom_ecole**$niveau**$nom_p**$nom_sous_d'>" .$nom_ecole ."</option>");
                                    ...
                                    <div class="col-sm-2">
                                        <button id="select_ecole_btn_red" class="btn btn-primary">Confirmer</button>
                                    </div>
...
<select id="select_ecole_mod" data-live-search="true" class="selectpicker"  title="Selectionner une école" data-selected-text-format="count" tabindex="-98"  >';
                                    ...
                                    {  
                                        ...
                                        if (count($coord) >= 1) {
                                            foreach ($coord as $res ) {
                                               $id = $res["id"];
                                                $class_sec_co = query("SELECT COUNT(DISTINCT belongs_to) as nbr FROM redoublants WHERE belongs_to = ?",$id);
            ...
            if ($class_sec_co[0]["nbr"] == 0) {
                                     ...
                                     echo '</select></div>
                                     <div class="col-sm-2">
                                     <button id="modif_btn_redoublant" class="btn btn-primary ">Confirmer</button>
                                     </div>
                                     <div class="row">
    ...
    ?>
                ...
                <form id="ecolemat_form_red" class="row p-10" style="display: none;">
...
echo "</tr>"; 
    ...
    <button id="ecolemat_form_button" class="btn btn-info col-sm-12 waves-effect btn-lg" type="submit"  >ENREGISTRER</button>
            ...
            <form id="ecolepri_form_red"  class="row p-10" style="display: none;">
...
echo "</tr>"; 
    ...
    <button id="ecolepri_form_button" class="btn btn-info col-sm-12 waves-effect btn-lg" type="submit">ENREGISTRER</button>
                            <span class="affreslt_ecole"></span>
                            <input type="hidden" name="current_ecole" id="current_ecole1">
                   </form>

            <form id="ecoleco_form_red"  class="row p-10" style="display: none;">
                       <table id="ecolesec_form_table" style="margin: 0 auto" class="naledi_yellow  col-sm-12 table-bordered pointInputTable table-condensed">
                       <thead>
                            <tr class="warning">
                                <th rowspan="2"> SEXE/CLASSE </th>
                                <th colspan="3">1ère </th>
...
echo "<tr id='tabp6ans_red$i'>";
    ...
    //soustractiuon de totaux
    if ( $j==0 || $j==1 || $j==3 || $j==4 || $j==6 ||$j==7 ||$j==9|| $j==10|| $j==12||$j==13||$j==15||$j==16 ) {
     echo "<td><input autocomplete='false' id='tabp6ans_red$i$j' type='text' class='form-control tabp6ans_red tabp6ans_redfg$i$j' name='tabp6ans_redfg$i$j'></td>";
    }
    else echo "<td id='tabp6ans_red$i$j'>0</td>";
...
echo "</tr>"; 
    ...
    <button id="ecolesec_form_button" class="btn btn-info col-sm-12 waves-effect btn-lg" type="submit">ENREGISTRER</button>
                            <span class="affreslt_ecole"></span>
