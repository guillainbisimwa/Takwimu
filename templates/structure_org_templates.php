                    ...
                    <?php endif; ?>
                      <li class="active sub-menu">
                        ...
                        <ul>
                            ...
                            <li><a class="active"  href="structure_org.php">Structures organisées</a></li>
...
<?php endif; ?>
                        ...
                        <div id="todo1" class="card">
                            <div class="card-header bgm-bluegray1 ch-alt m-b-20">
                               ...
                               <?php if(isset($_SESSION['paroisse'])):
                                    ...
                                    echo "ENREGISTREMENT DES STRUCTURES ORGANISEES DANS LA PAROISSE ".$np[0]["nom_paroisse"];
                                ?>
                                <?php else: 
                                    echo "ENREGISTREMENT DES STRUCTURES ORGANISEES DANS TOUTES LES PAROISSES";
        ...
        foreach ($table_option1 as $option1) {
            ...
            $class_str_org = query("SELECT COUNT(DISTINCT id_ecole) as nbr FROM structure_organisee WHERE id_ecole = ?",$id_e);
            ...
            if ($class_str_org[0]["nbr"] == 0) {
                echo("<option  value='$nom_ecole**$niveau**$nom_p**$nom_sous_d'>" .$nom_ecole ."</option>");
                                    ...
                                    <div class="col-sm-2">
                                        <button id="select_structure_btn" class="btn btn-primary">Confirmer</button>
                                    </div>
...
<select id="select_ecole_mod" data-live-search="true" class="selectpicker"  title="Selectionner une école" data-selected-text-format="count" tabindex="-98"  >';
                                    ...
                                    {  
                                        ...
                                        if (count($coord) >= 1) {
                                            foreach ($coord as $res ) {
                                               $id = $res["id"];
                                            $class_str_org = query("SELECT COUNT(DISTINCT id_ecole) as nbr FROM structure_organisee WHERE id_ecole = ?",$id);
                                     ...
                                     echo '</select></div>
                                     <div class="col-sm-2">
                                     <button id="button_str_org_mod" class="btn btn-primary ">Selectionner</button>
                                     </div>
                                     <div class="row">
    ...
    ?>
                ...
                <form id="structuremat_form" action="structure_org.php" method="POST" class="row p-10" style="display: none;">
...
echo "</tr>"; 
    ...
    <button id="structuremat_form_button" class="btn btn-info col-sm-12 waves-effect btn-lg" type="submit"  >ENREGISTRER</button>
            ...
            <form id="stucturepri_form" action="structure_org.php" method="POST" class="row p-10" style="display: none;">
