<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      if ($id_last_insert[0]["id_niveau"] == "Maternelle") {
        ...
        $class_mat1 = query("SELECT * FROM `structure_autorisee` WHERE id_ecole = ? and nom_class = ?",$id_last, "1");
        $class_mat2 = query("SELECT * FROM `structure_autorisee` WHERE id_ecole = ? and nom_class = ?",$id_last, "2");
        $class_mat3 = query("SELECT * FROM `structure_autorisee` WHERE id_ecole = ? and nom_class = ?",$id_last, "3");
        ...
        echo '<form id="structuremat_aut_form_mod"  class="row p-10">
...
echo "</tr>"; 
    ...
    <button id="structuremat_form_button" class="btn btn-danger col-sm-12 waves-effect btn-lg" type="submit"  >MODIFIER</button>
        ...
        echo "<input value='$iddd' type='hidden' name='current_ecole_structure' id='current_ecole_structure'>
                   </form>";
      ...
      if ($id_last_insert[0]["id_niveau"] == "Primaire") {
        ...
        $class_mat2 = query("SELECT * FROM `structure_autorisee` WHERE id_ecole = ? and nom_class = ?",$id_last, "2");
        $class_mat3 = query("SELECT * FROM `structure_autorisee` WHERE id_ecole = ? and nom_class = ?",$id_last, "3");
        $class_mat4 = query("SELECT * FROM `structure_autorisee` WHERE id_ecole = ? and nom_class = ?",$id_last, "4");
        $class_mat5 = query("SELECT * FROM `structure_autorisee` WHERE id_ecole = ? and nom_class = ?",$id_last, "5");
        $class_mat6 = query("SELECT * FROM `structure_autorisee` WHERE id_ecole = ? and nom_class = ?",$id_last, "6");
        ...
        foreach ($class_mat6 as  $value) {
         ...
         echo '<form id="stucturepri_aut_form_mod" class="row p-10" >
